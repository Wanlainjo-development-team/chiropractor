...
const imageCards = ref([
  "https://res.cloudinary.com/rukkiecodes/image/upload/v1675896484/chriopractor/Chiropractors-TheBrost-Wayzata-013-2880w_q2tavs.jpg",
]);

const pageTexts = ref({
  title: "Knee, Hip & Ankle Pain Treatment",
  text: [
